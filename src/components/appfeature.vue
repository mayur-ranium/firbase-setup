...
<div class="app-features container flex-wrap lg:flex justify-center items-center mx-auto p-5 pb-20">
    ...
    <div class="px-5 lg:py-0 w-auto">
       ...
       <div class="mt-6 flex-wrap justify-center lg:flex lg:justify-between items-center lg:pr-12">
           <div class="bg-red-100 rounded-full p-2 w-14 m-auto md:m-0">
          ...
          <div class="mt-6 flex-wrap justify-center lg:flex lg:justify-between items-center lg:pr-12">
           <div class="bg-blue-100 rounded-full p-2.5 w-14 m-auto md:m-0">
          ...
          <div class="mt-6 flex-wrap justify-center lg:flex lg:justify-between items-center lg:pr-12">
           <div class="bg-green-100 rounded-full p-2 w-14 m-auto md:m-0">
