...
<div class="best-app-section bg-hero bg-contain bg-bottom bg-no-repeat">
    ...
    <div class="flex bg-slate-100 items-center w-[18.75rem] lg:w-[25rem] rounded-full mb-6 mx-auto lg:mx-4">
    <div class="w-10 bg-orange p-2 rounded-full mr-4">
        <img src="../assets/correct.png" alt="" classs="">
    </div>
    <div class="py-1 pr-2 lg:pr-12 text-sm text-center text-primary-clr lg:text-lg">
      #1 Editors Choice App of 2020 
    </div>

    </div>
    <h1 class="lg:text-6xl w-auto text-3xl font-semibold lg:leading-tight text-primary-clr px-1">
       Best app for your modern lifestyle
    </h1>
    <p class="text-sm lg:text-lg text-gray mt-4 px-2">
    ...
    <div class="topsection-mobilephone-img w-full lg:w-1/2">
        <img src="../assets/phone.png" alt="mobile-phone" class="mx-auto lg:ml-8">
    </div>
